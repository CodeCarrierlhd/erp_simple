...
import AddProduct from '../views/myProduct/AddProduct';
import ProductList from '../views/myProduct/ProductList';
import Warehouselist from '../views/myWarehouse/Warehouselist';
import AddWareHouse from '../views/myWarehouse/component/AddWareHouse';
import AddSaleList from '../views/myAfterSale/AddSaleList'
import AfterSaleList from '../views/myAfterSale/AfterSaleList'
import AddComponents from '../views/SalesStatistics/AddComponents'
import ComponentsList from '../views/SalesStatistics/ComponentsList'
...
export const routes = [
	...
	{ path: '/aftersale/add', component: AddSaleList },
	{ path: '/aftersale/list', component: AfterSaleList },
	{ path: '/partsStatics/add', component: AddComponents },
	{ path: '/partsStatics/list', component: ComponentsList },
